...
plt.title("EBV Motif Distribution (CASS endings)")
...
plt.savefig("EBV image/Heatmap of TRBV vs CDR3b Motifs in EBV-specific TCRs.png")
plt.show()
...
plt.savefig("EBV image/Motif Distribution by TRBV Gene (box Plot) in EBV-specific TCRs.png")
plt.show()
...
plt.ylabel("Motif")
plt.xlabel("TRBV Gene")
plt.savefig("EBV image/Motif Distribution by TRBV Gene (Violin Plot) in EBV-specific TCRs.png")
plt.show()
